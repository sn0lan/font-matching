...
LIBDIR = '/Users/sn0lan/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-arch', 'i386', '../deps/libzip-0.10/lib/.libs/libzip.a', '-Wl,-search_paths_first', '-lz']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/sn0lan/.node_libraries'
PREFIX = '/usr/local'
